...
namespace Inheritance.Geometry.Virtual
{
    ...
    public class CompoundBody : Body
    {
        ...
        public override RectangularCuboid GetBoundingBox()
        {
            ...
            {
                var subX = Math.Abs(((RectangularCuboid)Parts[0]).Position.X - ((RectangularCuboid)Parts[1]).Position.X);
                var subY = Math.Abs(((RectangularCuboid)Parts[0]).Position.Y - ((RectangularCuboid)Parts[1]).Position.Y);
                var subZ = Math.Abs(((RectangularCuboid)Parts[0]).Position.Z - ((RectangularCuboid)Parts[1]).Position.Z);
            ...
            return new RectangularCuboid(new Vector3(Position.X, Position.Y, sizeZ / 2 - radius + Position.Z), sizeX, sizeY, sizeZ);
        }
    }
}